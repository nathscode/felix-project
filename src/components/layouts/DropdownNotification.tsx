	...
	return (
		<ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
			<li>
				...
				{dropdownOpen && (
					<div
						className={`absolute  mt-2.5 flex h-90 w-[300px] flex-col rounded-sm border border-stroke bg-white shadow-default right-5  sm:right-0 sm:w-80`}
					>
						...
						<ul className="flex h-auto flex-col overflow-y-auto px-4">
							<li>
								...
								>
									<p className="text-sm">
										<span className="text-black font-bold">Join doe</span> Just
										made a reservation on a property, awaiting approval
									</p>
